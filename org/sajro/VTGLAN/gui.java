...
public class gui {
	...
	private void initialize(){
		...
		{
			int wrongJavaResponse = JOptionPane.showConfirmDialog(frame, "Please use Java 7 otherwise Minecraft wont run.", "Warning", -1);
		...
		{
			int response = JOptionPane.showConfirmDialog(frame, "The Launcher should be alone in the folder\nWant to move it?", "Warning", 0);
			if (response == 0)
			{
				System.exit(0);
			}
		...
		tabbedPane.addChangeListener(new ChangeListener() { //add the Listener
		        ...
		        public void stateChanged(ChangeEvent e) {
		            ...
		            System.out.println("Pane"+tabbedPane.getSelectedIndex());
